    ...
    bookmark = () => {
        ...
        AuthServices.BookMark(this.state.CourseId, this.props.CourseType, form)
            .then(response => {
                ...
                console.log(this.state.bookmarked, "noo");
                let icon = "error", title = "Course deregistered", text = ""
                if (this.state.bookmarked) {
                    title = "Good job!"
                    text = "You have Enrolled the course!"
                    icon = "success"
                }
            ...
            <div className="">
                ...
                <div className="Course-Teacher-bookmark">
                    <div className="Course-teacher-name">
                        ...
                        <Link className="link" to={`/chat/?room=${this.state.CourseId}&CourseName=${this.props.title}&UserName=${localStorage.getItem('userName')}&userId=${localStorage.getItem('userId')}`}>
