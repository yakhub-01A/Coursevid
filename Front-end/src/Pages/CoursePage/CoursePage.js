...
class CoursePage extends Component {
    ...
    updateBookmark() {
        let tempData = this.state.CoursesInfo;
        let user = localStorage.getItem('userId')
        let ind = this.state.CoursesInfo.bookmark.indexOf(user)
        if (ind > -1) {
            tempData['bookmark'].splice(ind, 1)
        } else {
            tempData['bookmark'].push(user)
        }
        this.setState({ CoursesInfo: tempData })
    }
    render() {
        ...
        let bookmarkClass = "Course-Video is-disabled"
                ...
                <div className="coursePage">
                    ...
                    <div className="container">
                        ...
                        <div className="Main-Section">
                            ...
                            <div aria-disabled={!bookmark} className={`Course-Video ${!bookmark ? 'is-disabled' : ''}`}>
                                {console.log(bookmark, '09')}
                        ...
                        <div className="Section2">
                            ...
                            <div aria-disabled={!bookmark} style={{ marginBottom: "100px" }} className={`flex-center ${!bookmark ? 'is-disabled' : ''}`}>

                                {VideoUrl}
                                <div aria-disabled={!bookmark} className={`progressBar ${!bookmark ? 'is-disabled' : ''}`}>
